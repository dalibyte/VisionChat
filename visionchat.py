...
def extract_questions(text):
    ...
    questions = [sent for sent in sentences if re.match(r'(?i)\b(who|after|define|describe|what|when|which|where|why|how|is|are|was|were|do|does|name|did)\b', sent) and sent.endswith('?')]
    return questions
